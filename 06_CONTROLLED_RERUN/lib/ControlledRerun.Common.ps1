...
function Get-CRConfigDefinitions {
    return @(
        [pscustomobject]@{Role='P1_CRITICAL';RelativePath='01_ARTIFACTS\candidate\last_version\Custom.TFM.HIDS.P1.Critical.Priority.Event_v1.yaml';SHA256='8A1FF2654405AF9E4412D32EF0C2BE08A383924654AA764A04AB264BAA42EDD7'},
        [pscustomobject]@{Role='P2_EVENT';RelativePath='01_ARTIFACTS\candidate\Custom.TFM.HIDS.P2.High.Forensic.Event_v1.yaml';SHA256='255C5F7CA39E362FE45106C662C4C35730EFF57A4063A1E9973FD11A6375FAA2'},
        [pscustomobject]@{Role='P3_EVENT';RelativePath='01_ARTIFACTS\candidate\Custom.TFM.HIDS.P3.Medium.Behavioral.Event_v1.yaml';SHA256='C591CB849753194F6F87834C1E0F34EDE6CDFF6B31BC63650A1D281ADA1D410A'},
        [pscustomobject]@{Role='P4';RelativePath='01_ARTIFACTS\candidate\Custom.TFM.HIDS.P4.Low.Basic_v2.yaml';SHA256='927AF9AD3D4CB4B6FBB1BC38C48A77FB4018C91709334D2A2E68D979BC5BCB98'},
        [pscustomobject]@{Role='SOC_ROUTER';RelativePath='01_ARTIFACTS\candidate\last_version\Custom.TFM.HIDS.Router.JSONL.Discord.SOC_v3.yaml';SHA256='F48AE437756348D6973496257D784E462A09A011975403244D7A3B0C328D9B0F'},
        [pscustomobject]@{Role='TEC_RUNNER';RelativePath='03_RUNNERS\TFM_Run_All_TEC_Tests_v6_PATCHED_4104.ps1';SHA256='C023F8F7DC4D90977C4F6C76C8147A90C3558D62E14D9E1A265358DCDFF68367'},
        [pscustomobject]@{Role='FP_RUNNER';RelativePath='03_RUNNERS\TFM_Run_FP_Tests_v1.ps1';SHA256='557B9799DAA62CFD68A31EF79296997137DBB8E355175615F20F44F8AD032528'},
        [pscustomobject]@{Role='BENCHMARK_RUNNER';RelativePath='03_RUNNERS\TFM_Benchmark_VR_Resource_Usage_v1.ps1';SHA256='1C86D7493485C81D80398416FA0671B06F4A1134E89E1F9B6FE29C6E0F6EAB4F'},
        [pscustomobject]@{Role='RECEIVER';RelativePath='02_SCRIPTS\candidate\receiver_tfm_v4.py';SHA256='D61A86270EA822D2D4195E8C506738D9544D7964C23CB174D9F09EE52DD84CF6'}
    )
}
