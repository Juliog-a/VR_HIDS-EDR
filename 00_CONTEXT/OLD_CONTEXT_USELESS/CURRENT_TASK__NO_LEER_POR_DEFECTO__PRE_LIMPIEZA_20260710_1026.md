...
## Tarea activa actualizada 20260709_1825

Documento de resumen para ChatGPT/Codex: `CERRADA LOCALMENTE`.
...
- Leerlo como contexto rápido antes de continuar la memoria beta pre-PDF.
- Puede pegarse en ChatGPT para recuperar estado, criterios, hallazgos y pendientes.

Estado de la memoria:

- Se mantiene `APTO PARA REVISIÓN FINAL HUMANA`.
- No apto para PDF final todavía.

Pendiente principal:

1. Cerrar Word y confirmar que desaparece el temporal `~$...`.
2. Resolver índice general duplicado.
3. Actualizar índices/listas.
4. Reescribir frase JSONL/Discord del capítulo VI.
5. Revisar visualmente tablas, captions y anexos.

## Tarea activa actualizada 20260709_1820

Revisión final pre-PDF de memoria beta: `CERRADA LOCALMENTE`.
...
- `TFM_MEMORIA_BETA_v1.docx` original no modificado.
- Copia `REVISION_PREPDF` creada y corregida con cambios menores seguros.
- Veredicto global: `APTO PARA REVISIÓN FINAL HUMANA`.
- No apto para PDF final todavía.
- Cierre estimado: 88 %.

Bloqueantes antes de PDF:

1. Cerrar Word y confirmar que desaparece temporal `~$M_MEMORIA_BETA_v1_REVISION_PREPDF.docx`.
2. Eliminar/regenerar índice general duplicado.
3. Actualizar índice general, tablas, figuras y código.
4. Corregir índice de tablas desactualizado.
5. Reescribir en capítulo VI la frase que trata JSONL/Discord como resultado final.
6. Revisar visualmente tablas anchas, captions, saltos de página y anexos A-L.
...
## Tarea activa actualizada 20260708_1250

Iteracion documental beta v1 - referencias y anexos: `CERRADA LOCALMENTE`.
...
- Referencias bibliograficas completadas en formato APA dentro de la memoria.
- Citas insertadas en el cuerpo para MITRE, Velociraptor, Sysmon, PowerShell
  Logging, Wazuh y fuentes internas del TFM.
- Anexos A-L desarrollados dentro del Word beta.
- TEC-009 mantenida como exfiltracion HTTP controlada en laboratorio.
- Perfiles P1/P2/P3/P4 formulados como perfiles de artifacts/severidad, no
  prioridades de planificacion.
- Wazuh mantenido como contraste HIDS/SIEM, con gap 110201 documentado.
- Indice/listas actualizados mediante Word en modo invisible.

Verificacion:

- Word abrio, actualizo y guardo `TFM_MEMORIA_BETA_v1.docx` correctamente.
- `.docx` verificado como paquete OpenXML.
- Busqueda final sin formulaciones antiguas que invaliden TEC-009 ni frases
  ambiguas sobre SERVER_EVENT, Discord o benchmark.
- SHA-256 final beta:
  `DFB82ECF760E56C9F8E8D78485CF7D9571DCB6C6254D6281C9BF3BB95D9025C3`.

Control:

- `01_ARTIFACTS/validated` no se ha modificado.
- No se han modificado scripts, runners, evidencias ni Exceles.
- No se han ejecutado pruebas experimentales.

Pendiente:

1. Revision visual humana en Word: tablas, captions, saltos de pagina y anexos.
2. Adaptar APA si la Universidad exige una variante concreta.
3. Confirmar capturas finales.
4. Exportar PDF final cuando la beta sea aceptada.

## Tarea activa actualizada 20260708_1155

Iteracion documental beta v1: `CERRADA LOCALMENTE`.

Entregables:

- `08_MEMORIA/ITERACION_PROXIMA_MEMORIA_10_10/TFM_MEMORIA_BETA_v1.docx`.
- `08_MEMORIA/ITERACION_PROXIMA_MEMORIA_10_10/PLAN_PENDIENTE_POR_CAPITULOS.md`.
- `08_MEMORIA/ITERACION_PROXIMA_MEMORIA_10_10/CAMBIOS_RECOMENDADOS_BETA_v1.md`.
- `08_MEMORIA/ITERACION_PROXIMA_MEMORIA_10_10/CONTEXTO_MEMORIA_BETA_v1.md`.
- `08_MEMORIA/ITERACION_PROXIMA_MEMORIA_10_10/README_ITERACION_BETA_v1.md`.
- `08_MEMORIA/ITERACION_PROXIMA_MEMORIA_10_10/00_DOCUMENTOS_ARCHIVADOS_NO_USAR.md`.

Cambios principales:

- Beta regenerada desde `08_MEMORIA/TFM.docx`, documento real mas actualizado.
- TEC-009 corregida como exfiltracion HTTP controlada en laboratorio.
- Tabla Wazuh - Velociraptor actualizada sin `Pendiente de campana VR`.
- Benchmark reforzado como coste operativo, no calidad de deteccion.
- Documentos auxiliares antiguos archivados en `_ARCHIVO_OBSOLETO_NO_USAR`.

Control:

- `08_MEMORIA/TFM.docx` no se ha modificado por esta iteracion.
- `01_ARTIFACTS/validated` no se ha modificado.
- No se han modificado scripts, runners, evidencias ni Exceles.
- No se han ejecutado pruebas experimentales.
...
2. Actualizar indice, listas de figuras y listas de tablas.
3. Revisar visualmente tablas, captions y paginacion.
4. Normalizar bibliografia.
5. Confirmar anexos/capturas finales.
6. Mantener TEC-009 como exfiltracion HTTP controlada; receptor final ausente
   solo como limitacion documental secundaria si aplica.
