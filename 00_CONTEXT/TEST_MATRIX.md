...
| TEC-009 | Staging T1074.001, Archive T1560.001 y transferencia controlada T1048.003 | Crear ZIP dummy y enviarlo por POST al receiver del investigador | ZIP y copia existen; SHA-256; HTTP 2xx; `UploadSucceeded=True`; evidence check sin FAIL/WARNING | P1/P2 4104 fuerte; P3 `TEC009_HTTP_ZIP_Upload_4104` | P1, P2, P3 | Receiver POST, `application/zip`, ZIP recibido y SHA-256 origen=destino; Sysmon 1/3/11 solo contexto |
...
- TEC-009 es inválida sin transferencia y concordancia SHA-256 real.
