...
| Excel visibilidad en memoria | `08_MEMORIA/Excel_visibilidad_FP/TFM_VISIBILIDAD_DETECCION_FP_WAZUH_FINAL_26062026.xlsx` | FINAL |
| Benchmark | `04_EVIDENCE/Excel_benchmark_26062026` | FINAL |
| Excel benchmark en memoria | `08_MEMORIA/Excel_benchmark/TFM_BENCHMARK_RENDIMIENTO_VELOCIRAPTOR_FINAL_26062026.xlsx` | FINAL |
| Artifacts Velociraptor | `01_ARTIFACTS/validated` | FINAL |
| Reglas Wazuh | `10_WAZUH/tfm_wazuh_custom_rules_v1.xml` | FINAL |
| Memoria vigente | `08_MEMORIA/ITERACION_PROXIMA_MEMORIA_10_10/TFM_MEMORIA_BETA_v1_REVISION_PREPDF.docx` | VIGENTE PRE-PDF |
